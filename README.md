...
This screenshot shows the generated WAR artifacts stored in the S3 bucket with version history, which helps demonstrate artifact retention and traceability across builds.
